...
export default function EditorPage() {
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      ...
      // Call the enhanced AI API with current content context
  ...
  const handleResize = () => {
    ...
    const scaleX = 1920 / templateData.width;
    const scaleY = 1080 / templateData.height;
    ...
    fabricEditorRef.current.resizeCanvas(1920, 1080);
  };
